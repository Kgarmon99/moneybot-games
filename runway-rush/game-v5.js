...
const Game = {
  ...
  monthEvents: {
    3: { emoji: '💸', title: 'Server Costs Spike', desc: 'AWS bill doubled. Unexpected infrastructure costs.', effects: { cash: -5000, revenue: 0, burn: 1000 } },
    6: { emoji: '🏆', title: 'Product Hunt Launch', desc: 'Launch on Product Hunt. Viral traffic, but servers struggle.', effects: { cash: -3000, revenue: 5000, burn: 2000 } },
    9: { emoji: '👋', title: 'Key Employee Quits', desc: 'Your CTO leaves. Need to hire replacement fast.', effects: { cash: -10000, revenue: -2000, burn: 0 } },
    12: { emoji: '🎯', title: 'Demo Day', desc: 'Present to investors. Make it count.', effects: { cash: 0, revenue: 10000, burn: 0 } }
  },
