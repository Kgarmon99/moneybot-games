...
const IDEAS = [
  {
    ...
    difficulty: "hard",
    customers: [
      { name: "Sarah", role: "Product Manager", avatar: "👩", quote: "I don't really see the point. I already use Instagram for my dog.", signal: -15 },
      { name: "Mike", role: "Veterinarian", avatar: "👨", quote: "Pet owners need better health tracking, not another social app.", signal: -10 },
      { name: "Lisa", role: "Dog Walker", avatar: "👩", quote: "Maybe if it helped me find clients? But social? No.", signal: -5 },
      { name: "Tom", role: "Software Engineer", avatar: "👨", quote: "I'd use it if it had a marketplace for pet services.", signal: 5 },
      { name: "Anna", role: "Marketing Director", avatar: "👩", quote: "Pet influencers might like it, but that's a tiny market.", signal: -10 }
    ]
  },
  {
    ...
    difficulty: "medium",
    customers: [
      { name: "David", role: "CTO", avatar: "👨", quote: "We spend 20 hours/week on code review. This could save us.", signal: 20 },
      { name: "Emily", role: "Senior Dev", avatar: "👩", quote: "I worry about false positives. Bad suggestions hurt more than help.", signal: -5 },
      { name: "James", role: "Engineering Manager", avatar: "👨", quote: "If it integrates with our workflow, I'd pay for this.", signal: 15 },
      { name: "Rachel", role: "Junior Dev", avatar: "👩", quote: "I'd love feedback on my code style. This could teach me.", signal: 10 },
      { name: "Chris", role: "Freelancer", avatar: "👨", quote: "Too expensive for solo devs. Enterprise only?", signal: -5 }
    ]
  },
  {
    ...
    difficulty: "easy",
    customers: [
      { name: "Alex", role: "Indie Hacker", avatar: "👨", quote: "I love trying new tools. But $50/month is steep.", signal: 5 },
      { name: "Maya", role: "Solo Founder", avatar: "👩", quote: "Books and tools? Yes. T-shirts and stickers? No thanks.", signal: -5 },
      { name: "Ryan", role: "Bootstrapped Founder", avatar: "👨", quote: "If it saves me time finding good tools, I'm in.", signal: 15 },
      { name: "Sophie", role: "Designer", avatar: "👩", quote: "I already have too many subscriptions. Convince me.", signal: 0 },
      { name: "Jordan", role: "Developer", avatar: "👨", quote: "Community access would be the real value.", signal: 10 }
    ]
  }
];
